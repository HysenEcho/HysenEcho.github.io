...
$.ajax({
    ...
    data: {
        key: '3JZBZ-N6FW5-COCIF-IVNKB-BSC6F-O3BUY',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    try {
        ...
        document.getElementById("welcome-info").innerHTML =
            `<b><center>🎉 欢迎信息 🎉</center> <br>欢迎来自 <span style="color:#49b1f5">${pos}</span> 的小伙伴🤩<br>${timeChange}<br>您现在距离站长约 <span style="color:#49b1f5">${dist}</span> 公里!<br>当前的IP地址为： <span style="color:#b15700">${ip}</span><br>${posdesc}</b>`;
    } catch (err) {
